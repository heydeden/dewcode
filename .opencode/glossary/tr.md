...
- PR #15835: https://github.com/dedenwirjadinata/dewcode/pull/15835

## Do Not Translate (Locale Additions)

- `DEWCode` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `dewcode` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `DEWCode` in prose, `dewcode` only for exact technical identifiers
...
- Avoid changing `dewcode` to `DEWCode` inside commands, URLs, package names, or code literals
