...
Use this folder for locale-specific translation guidance that supplements `.dewcode/agent/translator.md`.
...
- PR #12345: https://github.com/dedenwirjadinata/dewcode/pull/12345

## Do Not Translate (Locale Additions)

- `DEWCode` (preserve casing)
