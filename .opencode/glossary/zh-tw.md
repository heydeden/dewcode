...
- PR #13942: https://github.com/dedenwirjadinata/dewcode/pull/13942

## Do Not Translate (Locale Additions)

- `DEWCode` (preserve casing in prose; keep `dewcode` only when it is part of commands, package names, paths, or code)
- `DEWCode Zen`
- `DEWCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `dewcode` in prose when referring to the product name; use `DEWCode`
