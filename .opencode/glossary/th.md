...
- PR #10809: https://github.com/dedenwirjadinata/dewcode/pull/10809
- PR #11496: https://github.com/dedenwirjadinata/dewcode/pull/11496

## Do Not Translate (Locale Additions)

- `DEWCode` (preserve casing in prose; keep `dewcode` only in commands, package names, paths, or code)
- `DEWCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
