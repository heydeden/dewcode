...
Desktop application and browser-based app issues, including `dewcode web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core dewcode server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

DEWCode Zen, DEWCode Go, and billing issues.
