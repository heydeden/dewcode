...
const tableBucketName = `dewcode-${$app.stage}-lake`
...
const firehose = new aws.kinesis.FirehoseDeliveryStream(
  "LakeFirehose",
  {
    name: `dewcode-${$app.stage}-lake-ingest`,
    destination: "iceberg",
