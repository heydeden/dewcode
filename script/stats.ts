...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/dedenwirjadinata/dewcode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for dedenwirjadinata/dewcode...\n")
...
console.log("Fetching npm all-time downloads for dewcode-ai...\n")
const npmDownloads = await fetchNpmDownloads("dewcode-ai")
