...
import { FileSystemWatcher } from "@dewcode-ai/schema/filesystem-watcher"
...
declare const DEWCODE_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof DEWCODE_LIBC === "undefined" ? undefined : DEWCODE_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@dewcode/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.DEWCODE_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.DEWCODE_EXPERIMENTAL_FILEWATCHER)) {
