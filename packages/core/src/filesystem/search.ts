...
export class Service extends Context.Service<Service, Interface>()("@dewcode/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.DEWCODE_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
