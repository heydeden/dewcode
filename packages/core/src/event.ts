...
import type { Data, Definition, Payload } from "@dewcode-ai/schema/event"
...
import { Durable } from "@dewcode-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@dewcode-ai/schema/event").ID
export type { Data, Definition, Payload } from "@dewcode-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@dewcode/Event") {}
