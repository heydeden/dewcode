...
import { Event } from "@dewcode-ai/schema/project-directories"
import { ProjectCopy } from "@dewcode-ai/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@dewcode/ProjectCopy") {}
