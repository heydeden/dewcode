...
import type { EffectDrizzleSqlite } from "@dewcode-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@dewcode/ProjectDirectories") {}
