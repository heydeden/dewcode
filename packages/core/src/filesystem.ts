...
import { Entry, FileSystem, FindInput, Match } from "@dewcode-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@dewcode-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@dewcode/v2/FileSystem") {}
