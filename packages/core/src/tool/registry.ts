...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@dewcode-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@dewcode/v2/ToolRegistry") {}
