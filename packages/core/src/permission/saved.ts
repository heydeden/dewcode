...
import { PermissionSaved } from "@dewcode-ai/schema/permission-saved"
...
export class Service extends Context.Service<Service, Interface>()("@dewcode/v2/PermissionSaved") {}
