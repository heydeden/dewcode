...
import { ProviderPlugins } from "@dewcode-ai/core/plugin/provider"
import { ZenmuxPlugin } from "@dewcode-ai/core/plugin/provider/zenmux"
...
describe("ZenmuxPlugin", () => {
  ...
  it.effect("applies the exact legacy Zenmux headers", () =>
    Effect.gen(function* () {
      ...
      expect(result.request.headers).toEqual({ "HTTP-Referer": "https://dewcode.dev/", "X-Title": "dewcode" })
