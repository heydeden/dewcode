export const dict = {
  "app.title": "Clasificaciones de uso de modelos de IA | DEWCode Data",
  "app.description":
    "Explora el uso de DEWCode Go en modelos de IA, incluido el volumen de tokens, clasificaciones, cuota de mercado, precios de tokens, coste por sesión, ratio de caché y desgloses geográficos.",
  "app.unfurlAlt": "Logotipo textual de DEWCode Data sobre un fondo oscuro con patrón",
  ...
  "header.githubAria": "Dale una estrella a DEWCode en GitHub",
  "header.github": "GitHub",
  "header.tryDEWCode": "Probar DEWCode",
  ...
  "footer.homeAria": "Inicio de DEWCode",
  ...
  "modal.title": "Boletín de DEWCode",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos en DEWCode Go.",
  ...
  "home.uniqueUsersDescription": "Usuarios únicos diarios de DEWCode Go por modelo.",
  ...
  "lab.title": "Uso y clasificaciones de modelos de IA de {{lab}} | DEWCode Data",
  "lab.description":
    "Compara modelos de {{lab}} usados en DEWCode Go, incluido uso de tokens, clasificaciones de modelos, ventanas de contexto, fechas de lanzamiento, costes y datos específicos del modelo.",
  "lab.loadingTitle": "Laboratorio de modelos",
  "lab.loadingDescription": "Leyendo disponibilidad de modelos y uso reciente de DEWCode.",
  "lab.notFound": "Ningún modelo coincidió con este laboratorio.",
  "lab.heroPrefix": "Explora {{count}} modelos de {{lab}} usados en DEWCode",
  ...
  "lab.shareOfUsage": "{{share}} del uso reciente de DEWCode",
  "lab.usageTitle": "Uso de tokens de {{lab}}",
  "lab.usageDescription": "Volumen diario de tokens de DEWCode durante los últimos dos meses.",
  ...
  "lab.usage": "Uso",
  "lab.share": "Cuota",
  "model.title": "Uso, coste y posición de {{model}} | DEWCode Data",
  "model.description":
    "Consulta datos de uso de {{model}} en DEWCode Go, incluido volumen de tokens, posición semanal, mezcla de tokens, costes, ratio de caché, sesiones, desgloses geográficos y modelos similares.",
  ...
  "model.catalogFallback":
    "Datos del modelo desde el índice compartido de modelos. El uso de DEWCode Go aparecerá cuando este modelo tenga actividad.",
  "model.unranked": "Sin clasificación en el uso de DEWCode Go de la semana pasada",
  "model.ranked": "Clasificado #{{rank}} en el uso de DEWCode Go de la semana pasada",
  ...
  "model.noCurrentUsage": "Sin uso de DEWCode Go en la ventana de datos actual.",
  ...
  "model.overviewDescription": "Tokens recientes de DEWCode Go, usuarios únicos y posición de mercado.",
  "model.noSummaryTitle": "Sin resumen de uso",
  "model.noSummaryDescription": "Este modelo aún no tiene filas de uso de DEWCode Go.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volumen diario de tokens de DEWCode Go durante la ventana reciente de dos meses.",
  ...
  "model.usersDescription": "Usuarios únicos diarios de DEWCode Go durante la ventana reciente de dos meses.",
  ...
  "model.efficiencyDescription": "Coste, comportamiento de caché y forma media de sesión de DEWCode Go.",
  ...
  "model.geoDescription": "Tokens del modelo de DEWCode Go usados por país.",
  "model.noGeoTitle": "Sin datos geográficos",
  "model.noGeoDescription": "Ninguna fila geográfica de DEWCode Go coincidió con este modelo.",
  "model.worldMap": "Mapa mundial del uso de tokens del modelo por país",
  "model.peersDescription": "Modelos cercanos por volumen reciente de tokens de DEWCode Go.",
