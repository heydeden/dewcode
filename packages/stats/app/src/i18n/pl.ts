export const dict = {
  "app.title": "Rankingi użycia modeli AI | DEWCode Data",
  "app.description":
    "Przeglądaj użycie DEWCode Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny DEWCode Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę DEWCode na GitHub",
  "header.github": "GitHub",
  "header.tryDEWCode": "Wypróbuj DEWCode",
  ...
  "footer.homeAria": "Strona główna DEWCode",
  ...
  "home.topModelsDescription": "Użycie modeli w DEWCode Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy DEWCode Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | DEWCode Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w DEWCode Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia DEWCode.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w DEWCode",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia DEWCode",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów DEWCode z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | DEWCode Data",
  "model.description":
    "Zobacz dane użycia {{model}} w DEWCode Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie DEWCode Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu DEWCode Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu DEWCode Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia DEWCode Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny DEWCode Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia DEWCode Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów DEWCode Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy DEWCode Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji DEWCode Go.",
  ...
  "model.geoDescription": "Tokeny modelu DEWCode Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne DEWCode Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów DEWCode Go.",
