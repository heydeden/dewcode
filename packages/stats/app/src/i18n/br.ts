export const dict = {
  "app.title": "Ranking de uso de modelos de IA | DEWCode Data",
  "app.description":
    "Explore o uso do DEWCode Go em modelos de IA, incluindo volume de tokens, rankings, participação de mercado, preço por token, custo por sessão, taxa de cache e distribuição geográfica.",
  "app.unfurlAlt": "Logotipo do DEWCode Data sobre um fundo escuro padronizado",
  ...
  "header.githubAria": "Dar estrela ao DEWCode no GitHub",
  "header.github": "GitHub",
  "header.tryDEWCode": "Experimente o DEWCode",
  ...
  "footer.homeAria": "Início do DEWCode",
  ...
  "modal.title": "Newsletter do DEWCode",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos no DEWCode Go.",
  ...
  "home.uniqueUsersDescription": "Usuários únicos diários do DEWCode Go por modelo.",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | DEWCode Data",
  "lab.description":
    "Compare modelos da {{lab}} usados no DEWCode Go, incluindo uso de tokens, ranking de modelos, janelas de contexto, datas de lançamento, custos e dados específicos de cada modelo.",
  "lab.loadingTitle": "Laboratório de modelos",
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do DEWCode.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no DEWCode",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do DEWCode",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do DEWCode nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | DEWCode Data",
  "model.description":
    "Veja dados de uso de {{model}} no DEWCode Go, incluindo volume de tokens, ranking semanal, combinação de tokens, custos, taxa de cache, sessões, distribuição geográfica e modelos pares.",
  ...
  "model.catalogFallback":
    "Fatos do modelo do índice compartilhado de modelos. O uso no DEWCode Go aparece quando este modelo tiver atividade.",
  "model.unranked": "Sem classificação no uso do DEWCode Go da última semana",
  "model.ranked": "Classificado em #{{rank}} no uso do DEWCode Go da última semana",
  ...
  "model.noCurrentUsage": "Sem uso do DEWCode Go na janela de dados atual.",
  ...
  "model.overviewDescription": "Tokens recentes do DEWCode Go, usuários únicos e posição de mercado.",
  "model.noSummaryTitle": "Sem resumo de uso",
  "model.noSummaryDescription": "Este modelo ainda não tem linhas de uso do DEWCode Go.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume diário de tokens do DEWCode Go na janela recente de dois meses.",
  ...
  "model.usersDescription": "Usuários únicos diários do DEWCode Go na janela recente de dois meses.",
  ...
  "model.efficiencyDescription": "Custo, comportamento de cache e formato médio da sessão do DEWCode Go.",
  ...
  "model.geoDescription": "Tokens do modelo DEWCode Go usados por país.",
  "model.noGeoTitle": "Sem dados geográficos",
  "model.noGeoDescription": "Nenhuma linha geográfica do DEWCode Go correspondeu a este modelo.",
  "model.worldMap": "Mapa-múndi do uso de tokens do modelo por país",
  "model.peersDescription": "Modelos próximos por volume recente de tokens do DEWCode Go.",
