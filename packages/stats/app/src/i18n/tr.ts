export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | DEWCode Data",
  "app.description":
    "DEWCode Go kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde DEWCode Data logosu",
  ...
  "header.githubAria": "GitHub'da DEWCode'a yıldız ver",
  "header.github": "GitHub",
  "header.tryDEWCode": "DEWCode'u dene",
  ...
  "footer.homeAria": "DEWCode ana sayfası",
  ...
  "home.topModelsDescription": "DEWCode Go genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz DEWCode Go kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | DEWCode Data",
  "lab.description":
    "DEWCode Go'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son DEWCode kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "DEWCode'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son DEWCode kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük DEWCode token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | DEWCode Data",
  "model.description":
    "{{model}} için DEWCode Go kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda DEWCode Go kullanımı görünür.",
  "model.unranked": "Geçen haftaki DEWCode Go kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki DEWCode Go kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde DEWCode Go kullanımı yok.",
  ...
  "model.overviewDescription": "Son DEWCode Go tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz DEWCode Go kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük DEWCode Go token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz DEWCode Go kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama DEWCode Go oturum yapısı.",
  ...
  "model.geoDescription": "Ülkeye göre kullanılan DEWCode Go model tokenları.",
  "model.noGeoTitle": "Coğrafi veri yok",
  "model.noGeoDescription": "Bu modelle eşleşen DEWCode Go coğrafi satırı yok.",
  "model.worldMap": "Ülkeye göre model token kullanımının dünya haritası",
  "model.peersDescription": "Son DEWCode Go token hacmine göre yakındaki modeller.",
