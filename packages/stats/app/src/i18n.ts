...
const en = {
  "app.title": "AI Model Usage Rankings | DEWCode Data",
  "app.description":
    "Explore DEWCode Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "DEWCode Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star DEWCode on GitHub",
  "header.github": "GitHub",
  "header.tryDEWCode": "Try DEWCode",
  ...
  "home.topModelsDescription": "Usage of models across DEWCode Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique DEWCode Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | DEWCode Data",
  "lab.description":
    "Compare {{lab}} models used in DEWCode Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent DEWCode usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in DEWCode",
  ...
  "lab.shareOfUsage": "{{share}} of recent DEWCode usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | DEWCode Data",
  "model.description":
    "View {{model}} DEWCode Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. DEWCode Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's DEWCode Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's DEWCode Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No DEWCode Go usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no DEWCode Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.geoDescription": "DEWCode Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No DEWCode Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent DEWCode Go token volume.",
