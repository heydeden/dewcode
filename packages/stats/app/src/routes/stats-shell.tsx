import dewcodeWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const githubLink = {
  ...
  apiHref: "https://api.github.com/repos/dedenwirjadinata/dewcode",
  fallbackStars: "150K",
}
export const themePreferences = ["dark", "light", "system"] as const
export const themeStorageKey = "dewcode:stats-theme"
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://dewcode.dev/">
            <strong>{i18n.t("header.tryDEWCode")}</strong>
          </a>
          <button
...
function DEWCodeMark() {
  return (
    <svg data-slot="dewcode-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://dewcode.dev/legal/terms-of-service", label: i18n.t("footer.terms") },
    { href: "https://dewcode.dev/legal/privacy-policy", label: i18n.t("footer.privacy") },
  ]
  const connect = [
    { href: "mailto:hello@dewcode.dev", label: i18n.t("footer.contact") },
    { href: "https://dewcode.dev/discord", label: i18n.t("footer.community") },
    { href: "https://x.com/dewcode", label: "X" },
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://dewcode.dev" aria-label={i18n.t("footer.homeAria")}>
          <DEWCodeMark />
        </a>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={dewcodeWordmarkDark} alt="DEWCode" />
          <button
