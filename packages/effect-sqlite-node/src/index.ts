...
export const TypeId: TypeId = "~@dewcode-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@dewcode-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@dewcode-ai/effect-sqlite-node/NodeSqliteClient")
