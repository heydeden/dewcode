...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "DEWCODE.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/dewcode/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/dewcode (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/dewcode/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/dewcode/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const DEWCODE_DB|DEWCODE_DB|DEWCODE_DEV|Global\\.Path\\.data|data =" in packages/dewcode/src (115 matches)',
  },
] as const
