...
import type { PermissionRequest } from "@dewcode-ai/sdk/v2"
...
import { DEWCODE_BASE_MODE, useBindings, useCommandShortcut } from "../../keymap"
          ...
          body={
            <Switch>
              <Match when={props.request.always.length === 1 && props.request.always[0] === "*"}>
                <TextBody title={"This will allow " + props.request.permission + " until DEWCode is restarted."} />
              </Match>
              <Match when={true}>
                <box paddingLeft={1} gap={1}>
                  <text fg={theme.textMuted}>This will allow the following patterns until DEWCode is restarted</text>
                  <box>
  ...
  return (
    ...
    >
      <box gap={1} paddingLeft={1} paddingRight={3} paddingTop={1} paddingBottom={1}>
        ...
        <box paddingLeft={1}>
          <text fg={theme.textMuted}>Tell DEWCode what to do differently</text>
        </box>
      </box>
      <box
