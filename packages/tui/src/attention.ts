...
import defaultSoundPath from "@dewcode-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@dewcode-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@dewcode-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@dewcode-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@dewcode-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@dewcode-ai/ui/audio/yup-01.mp3" with { type: "file" }
