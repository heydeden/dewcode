...
Practical reference for the current tool-migration state in `packages/dewcode`.
...
Tool tests should use the existing Effect helpers in `packages/dewcode/test/lib/effect.ts`:
