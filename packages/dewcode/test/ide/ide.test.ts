...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders DEWCODE_CALLER", () => {
    process.env["DEWCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode DEWCODE_CALLER", () => {
    process.env["DEWCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown DEWCODE_CALLER", () => {
    process.env["DEWCODE_CALLER"] = "unknown"
