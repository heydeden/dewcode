...
test("parses valid share URLs", () => {
  expect(parseShareUrl("https://dewcode.dev/share/Jsj3hNIW")).toBe("Jsj3hNIW")
...
test("rejects invalid URLs", () => {
  expect(parseShareUrl("https://dewcode.dev/s/Jsj3hNIW")).toBeNull() // legacy format
  expect(parseShareUrl("https://dewcode.dev/share/")).toBeNull()
  expect(parseShareUrl("https://dewcode.dev/share/id/extra")).toBeNull()
