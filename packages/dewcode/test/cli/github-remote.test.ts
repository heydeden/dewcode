...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/dewcode.git")).toEqual({ owner: "sst", repo: "dewcode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/dewcode")).toEqual({ owner: "sst", repo: "dewcode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/dewcode.git")).toEqual({ owner: "sst", repo: "dewcode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/dewcode")).toEqual({ owner: "sst", repo: "dewcode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/dewcode.git")).toEqual({ owner: "sst", repo: "dewcode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/dewcode")).toEqual({ owner: "sst", repo: "dewcode" })
})
