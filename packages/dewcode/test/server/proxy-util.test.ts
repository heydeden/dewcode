...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips dewcode-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-dewcode-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-dewcode-directory")).toBeNull()
      expect(result.get("x-dewcode-workspace")).toBeNull()
