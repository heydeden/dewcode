...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips dewcode-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-dewcode-directory"]).toBeUndefined()
      expect(forwarded["x-dewcode-workspace"]).toBeUndefined()
