 ...
 *   "@dewcode/ServerAuthConfig",
 *   {
 *     password: Config.string("DEWCODE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("DEWCODE_SERVER_USERNAME").pipe(Config.withDefault("dewcode")),
 *   },
 * ) {}
 *
