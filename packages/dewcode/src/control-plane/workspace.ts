...
import { EventSequenceTable, EventTable } from "@dewcode-ai/core/event/sql"
...
import { WorkspaceEvent } from "@dewcode-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@dewcode/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        DEWCODE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        DEWCODE_WORKSPACE_ID: config.id,
        DEWCODE_EXPERIMENTAL_WORKSPACES: "true",
