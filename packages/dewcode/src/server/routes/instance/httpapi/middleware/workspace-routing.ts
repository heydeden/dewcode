...
>()("@dewcode/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@dewcode/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.DEWCODE_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.DEWCODE_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-dewcode-directory"] || process.cwd()
}
