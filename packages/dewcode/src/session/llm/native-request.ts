import type { JsonSchema, LLMRequest, ProviderMetadata } from "@dewcode-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@dewcode-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @dewcode-ai/llm request objects from dewcode's session/AI SDK-shaped data.
  return LLM.request({
