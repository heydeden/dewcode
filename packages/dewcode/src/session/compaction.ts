...
import { buildPrompt } from "@dewcode-ai/core/session/compaction"
import { SessionCompactionEvent } from "@dewcode-ai/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@dewcode/SessionCompaction") {}
