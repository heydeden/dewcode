...
import { Slug } from "@dewcode-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@dewcode-ai/llm"
...
import { locationServiceMapLayer } from "@dewcode-ai/core/location-services"
...
import { PartTable, SessionTable } from "@dewcode-ai/core/session/sql"
...
import { NonNegativeInt, optional } from "@dewcode-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".dewcode", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@dewcode/Session") {}
