...
import { gitlabAuthPlugin as GitlabAuthPlugin } from "dewcode-gitlab-auth"
import { PoeAuthPlugin } from "dewcode-poe-auth"
...
export class Service extends Context.Service<Service, Interface>()("@dewcode/Plugin") {}
