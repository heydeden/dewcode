import type { Hooks, PluginInput } from "@dewcode-ai/plugin"
import type { Model } from "@dewcode-ai/sdk/v2"
import { InstallationVersion } from "@dewcode-ai/core/installation/version"
import { OauthCallbackPage } from "@dewcode-ai/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. DEWCode will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
