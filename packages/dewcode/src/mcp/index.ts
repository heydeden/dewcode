...
import { McpEvent } from "@dewcode-ai/schema/mcp-event"
import { McpBrowser } from "./browser"

const DEFAULT_TIMEOUT = 30_000
export const CLIENT_OPTIONS = {
  capabilities: {
    // https://github.com/dedenwirjadinata/dewcode/issues/11948
    // sampling: {},
    // https://github.com/dedenwirjadinata/dewcode/issues/23066
    // elicitation: {},
    // https://github.com/dedenwirjadinata/dewcode/issues/2308
    roots: {},
    // https://github.com/dedenwirjadinata/dewcode/issues/28567
    // tasks: {},
  },
...
function createClient(directory: string) {
  const client: MCPClient = new Client(
    { name: "dewcode", version: InstallationVersion },
    {
      ...CLIENT_OPTIONS,
      listChanged: {
...
export class Service extends Context.Service<Service, Interface>()("@dewcode/MCP") {}
            ...
            if (isAuthError) {
              if (registrationRejected) {
                ...
                return events
                  .publish(TuiEvent.ToastShow, {
                    title: "MCP Authentication Required",
                    message: `Server "${key}" requires authentication. Run: dewcode mcp auth ${key}`,
                    variant: "warning",
                    duration: 8000,
                  })
                  .pipe(Effect.ignore, Effect.as(undefined))
