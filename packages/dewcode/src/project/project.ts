...
import { ProjectDirectoryTable, ProjectTable } from "@dewcode-ai/core/project/sql"
import { ProjectDirectories } from "@dewcode-ai/core/project/directories"
...
import { which } from "@dewcode-ai/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@dewcode/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.DEWCODE_FAKE_VCS)
