...
import type { Event, GlobalEvent, OpencodeClient } from "@dewcode-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@dewcode/RunStreamTransport") {}
