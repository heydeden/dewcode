// Shared type vocabulary for the direct interactive mode (`dewcode --mini`).
//
...
import type { OpencodeClient, PermissionRequest, QuestionRequest, ToolPart } from "@dewcode-ai/sdk/v2"
