...
//
// The saved variant persists across sessions in ~/.local/state/dewcode/model.json
...
class Service extends Context.Service<Service, VariantService>()("@dewcode/RunVariant") {}
