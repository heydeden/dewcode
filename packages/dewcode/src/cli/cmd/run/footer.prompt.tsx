...
import { normalizePromptContent } from "@dewcode-ai/tui/editor"
...
import { DEWCODE_BASE_MODE, useBindings } from "@dewcode-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close DEWCode" } satisfies SlashOption,
    ]
