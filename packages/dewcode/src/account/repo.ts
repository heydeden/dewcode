...
import { AccountStateTable, AccountTable } from "@dewcode-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@dewcode/AccountRepo") {}
