...
export class Service extends Context.Service<Service, Interface>()("@dewcode/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __DEWCODE_PHOTON_WASM_PATH?: string }).__DEWCODE_PHOTON_WASM_PATH =
