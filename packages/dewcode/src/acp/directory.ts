...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@dewcode/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@dewcode/ACPDirectory") {}
