...
Schema-first LLM core for dewcode. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@dewcode-ai/llm"
import { OpenAI } from "@dewcode-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@dewcode-ai/llm/providers"
