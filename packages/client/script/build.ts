...
import { compile, emitEffectImported, emitPromise, write } from "@dewcode-ai/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "DEWCodeEventEncoded",
              import: 'import type { DEWCodeEventEncoded } from "@dewcode-ai/protocol/groups/event"',
            },
          },
        }),
