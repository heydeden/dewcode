...
const releaseId = process.env.DEWCODE_RELEASE
if (!releaseId) throw new Error("DEWCODE_RELEASE is required")

const version = process.env.DEWCODE_VERSION
if (!version) throw new Error("DEWCODE_VERSION is required")
...
const macxTarGz = "dewcode-desktop-mac-x64.app.tar.gz"
const macaTarGz = "dewcode-desktop-mac-arm64.app.tar.gz"
