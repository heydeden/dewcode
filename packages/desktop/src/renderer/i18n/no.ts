export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av DEWCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av DEWCode er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.cli.installed.message":
    "CLI installert til {{path}}\n\nStart terminalen på nytt for å bruke 'dewcode'-kommandoen.",
