export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do DEWCode",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do DEWCode foi baixada. Você gostaria de instalá-la e reiniciar?",
