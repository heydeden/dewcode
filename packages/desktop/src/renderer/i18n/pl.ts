export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji DEWCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} DEWCode. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.cli.installed.message":
    "CLI zainstalowane w {{path}}\n\nUruchom ponownie terminal, aby użyć polecenia 'dewcode'.",
