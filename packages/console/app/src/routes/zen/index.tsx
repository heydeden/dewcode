...
import compareVideo from "../../asset/lander/dewcode-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/dewcode-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="dewcode:auth" content={loggedin() ? "true" : "false"} />
