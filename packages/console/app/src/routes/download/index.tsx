      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://dewcode.dev/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>dewcode.dev/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g dewcode-ai")}>
                <code>
                  npm i -g <strong>dewcode-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g dewcode-ai")}>
                <code>
                  bun add -g <strong>dewcode-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/dewcode")}>
                <code>
                  brew install <strong>anomalyco/tap/dewcode</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S dewcode")}>
                <code>
                  paru -S <strong>dewcode</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask dewcode-desktop")}>
                <code>
                  brew install --cask <strong>dewcode-desktop</strong>
                </code>
                <CopyStatus />
              </button>
