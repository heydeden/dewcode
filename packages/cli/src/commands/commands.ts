...
declare const DEWCODE_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof DEWCODE_CLI_NAME === "string" ? DEWCODE_CLI_NAME : "dewcode", {
  description: "DEWCode 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
