import { DEWCode } from "@dewcode-ai/client/effect"
...
import { createEmbeddedRoutes } from "@dewcode-ai/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("DEWCode.create")(function* () {
  ...
  const client = yield* DEWCode.make({ baseUrl: "http://dewcode.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@dewcode-ai/sdk-next/DEWCode") {}
