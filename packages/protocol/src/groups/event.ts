...
import type { Definition } from "@dewcode-ai/schema/event"
...
export const DEWCodeEvent = event.schema
export type DEWCodeEvent = typeof DEWCodeEvent.Type
export type DEWCodeEventEncoded = typeof DEWCodeEvent.Encoded
