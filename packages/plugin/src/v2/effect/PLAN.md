...
- Effect plugins import `@dewcode-ai/plugin/v2/effect`, not `@dewcode-ai/core`.
- Public domain values use generated `@dewcode-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@dewcode-ai/plugin/v2/effect`.
