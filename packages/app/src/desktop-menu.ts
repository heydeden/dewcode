...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    label: "Help",
    items: [
      { type: "item", label: "DEWCode Documentation", href: "https://dewcode.dev/docs" },
      { type: "item", label: "Support Forum", href: "https://discord.com/invite/dewcode" },
      { type: "item", label: "Export Logs...", command: "logs.export" },
      { type: "separator" },
      {
        type: "item",
        label: "Share Feedback",
        href: "https://github.com/dedenwirjadinata/dewcode/issues/new?template=feature_request.yml",
      },
      {
        type: "item",
        label: "Report a Bug",
        href: "https://github.com/dedenwirjadinata/dewcode/issues/new?template=bug_report.yml",
      },
    ],
  },
]
