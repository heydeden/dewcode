...
export const dict = {
  ...
  "dialog.provider.dewcode.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.dewcode.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.dewcodeGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "DEWCode tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve DEWCode'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.dewcodeZen.line1":
    "DEWCode Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.dewcodeZen.visit.prefix": "",
  "provider.connect.dewcodeZen.visit.link": "dewcode.dev/zen",
  "provider.connect.dewcodeZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak DEWCode'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak DEWCode'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler dewcode.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi DEWCode sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "DEWCode kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde DEWCode kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "DEWCode güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde DEWCode güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki DEWCode'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "DEWCode'u güncelle",
  "wsl.onboarding.dewcodeReadyIn": "{{distro}} içinde DEWCode hazır.",
  "wsl.onboarding.dewcodeReady": "DEWCode hazır.",
  "wsl.onboarding.installOpencodeIn": "DEWCode'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "DEWCode'u kur",
  ...
  "wsl.onboarding.distroStatus.dewcodeMissing": "DEWCode kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "DEWCode'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "DEWCode bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından DEWCode'u tekrar açın.",
  ...
  "toast.update.description": "DEWCode'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı DEWCode ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (dewcode.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: DEWCode henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "DEWCode ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "DEWCode Masaüstü",
  ...
  "settings.desktop.wsl.description": "DEWCode sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "DEWCode'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "DEWCode'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "DEWCode'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "DEWCode'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "DEWCode başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "DEWCode'un en son sürümünü kullanıyorsunuz.",
