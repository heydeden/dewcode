...
export const dict = {
  ...
  "dialog.provider.dewcode.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.dewcode.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.dewcodeGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av DEWCode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i DEWCode.",
  ...
  "provider.connect.dewcodeZen.line1":
    "DEWCode Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.dewcodeZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.dewcodeZen.visit.prefix": "Besøk ",
  "provider.connect.dewcodeZen.visit.link": "dewcode.dev/zen",
  "provider.connect.dewcodeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i DEWCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i DEWCode.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i dewcode.json",
  ...
  "dialog.server.description": "Bytt hvilken DEWCode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av DEWCode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til DEWCode-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (dewcode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at DEWCode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "DEWCode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør DEWCode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for DEWCode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan DEWCode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om DEWCode skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan DEWCode er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når DEWCode starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av DEWCode.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker DEWCode...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker DEWCode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer DEWCode...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer DEWCode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater DEWCode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater DEWCode",
  "wsl.onboarding.dewcodeReadyIn": "DEWCode er klar i {{distro}}.",
  "wsl.onboarding.dewcodeReady": "DEWCode er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer DEWCode i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.dewcodeMissing": "DEWCode er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før DEWCode kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "DEWCode kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter DEWCode på nytt.",
