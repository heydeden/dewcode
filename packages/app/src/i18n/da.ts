export const dict = {
  ...
  "dialog.provider.dewcode.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.dewcode.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.dewcodeGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af DEWCode",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i DEWCode.",
  ...
  "provider.connect.dewcodeZen.line1":
    "DEWCode Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.dewcodeZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.dewcodeZen.visit.prefix": "Besøg ",
  "provider.connect.dewcodeZen.visit.link": "dewcode.dev/zen",
  "provider.connect.dewcodeZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i DEWCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i DEWCode.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i dewcode.json",
  ...
  "dialog.server.description": "Skift hvilken DEWCode-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker DEWCode...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker DEWCode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer DEWCode...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer DEWCode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater DEWCode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater DEWCode",
  ...
  "wsl.onboarding.distroStatus.dewcodeMissing": "DEWCode er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før DEWCode kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "DEWCode kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter DEWCode igen.",
  ...
  "toast.update.description": "En ny version af DEWCode ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til DEWCode-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (dewcode.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, DEWCode understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "DEWCode inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør DEWCode-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for DEWCode",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan DEWCode ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om DEWCode følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan DEWCode er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når DEWCode starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af DEWCode.",
