export const dict = {
  ...
  "dialog.provider.dewcode.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.dewcode.tagline": "Reliable optimized models",
  "dialog.provider.dewcodeGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by DEWCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in DEWCode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.dewcodeZen.line1":
    "DEWCode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.dewcodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.dewcodeZen.visit.prefix": "Visit ",
  "provider.connect.dewcodeZen.visit.link": "dewcode.dev/zen",
  "provider.connect.dewcodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in DEWCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in DEWCode.",
  ...
  "dialog.plugins.empty": "Plugins configured in dewcode.json",
  ...
  "dialog.server.description": "Switch which DEWCode server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking DEWCode...",
  "wsl.onboarding.checkingOpencodeIn": "Checking DEWCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating DEWCode...",
  "wsl.onboarding.updatingOpencodeIn": "Updating DEWCode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update DEWCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update DEWCode",
  "wsl.onboarding.dewcodeReadyIn": "DEWCode is ready in {{distro}}.",
  "wsl.onboarding.dewcodeReady": "DEWCode is ready.",
  "wsl.onboarding.installOpencodeIn": "Install DEWCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install DEWCode",
  ...
  "wsl.onboarding.distroStatus.dewcodeMissing": "DEWCode not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before DEWCode can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "DEWCode could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen DEWCode.",
  ...
  "toast.update.description": "A new version of DEWCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the DEWCode team",
  ...
  "error.chain.checkConfig": "Check your config (dewcode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, DEWCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "DEWCode includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the DEWCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for DEWCode",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how DEWCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether DEWCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how DEWCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when DEWCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of DEWCode.",
