export const dict = {
  ...
  "dialog.provider.dewcode.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.dewcode.tagline": "Modelos optimizados y fiables",
  "dialog.provider.dewcodeGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por DEWCode",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en DEWCode.",
  ...
  "provider.connect.dewcodeZen.line1":
    "DEWCode Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.dewcodeZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.dewcodeZen.visit.prefix": "Visita ",
  "provider.connect.dewcodeZen.visit.link": "dewcode.dev/zen",
  "provider.connect.dewcodeZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en DEWCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en DEWCode.",
  ...
  "dialog.plugins.empty": "Plugins configurados en dewcode.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de DEWCode se conecta esta app.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando DEWCode...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando DEWCode en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando DEWCode...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando DEWCode en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza DEWCode en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar DEWCode",
  "wsl.onboarding.dewcodeReadyIn": "DEWCode está listo en {{distro}}.",
  "wsl.onboarding.dewcodeReady": "DEWCode está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala DEWCode en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar DEWCode",
  ...
  "wsl.onboarding.distroStatus.dewcodeMissing": "DEWCode no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que DEWCode pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "DEWCode no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir DEWCode.",
  ...
  "toast.update.description": "Una nueva versión de DEWCode ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de DEWCode",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (dewcode.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, DEWCode no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "DEWCode incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor DEWCode dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para DEWCode",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve DEWCode en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si DEWCode sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de DEWCode.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia DEWCode",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de DEWCode.",
