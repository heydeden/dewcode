export const dict = {
  ...
  "dialog.provider.dewcode.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.dewcode.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.dewcodeGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo DEWCode",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no DEWCode.",
  ...
  "provider.connect.dewcodeZen.line1":
    "DEWCode Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.dewcodeZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.dewcodeZen.visit.prefix": "Visite ",
  "provider.connect.dewcodeZen.visit.link": "dewcode.dev/zen",
  "provider.connect.dewcodeZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no DEWCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no DEWCode.",
  ...
  "dialog.plugins.empty": "Plugins configurados em dewcode.json",
  ...
  "dialog.server.description": "Trocar para qual servidor DEWCode este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o DEWCode...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o DEWCode em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o DEWCode...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o DEWCode em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o DEWCode em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o DEWCode",
  "wsl.onboarding.dewcodeReadyIn": "O DEWCode está pronto em {{distro}}.",
  "wsl.onboarding.dewcodeReady": "O DEWCode está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o DEWCode em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o DEWCode",
  ...
  "wsl.onboarding.distroStatus.dewcodeMissing": "DEWCode não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o DEWCode possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O DEWCode não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o DEWCode novamente.",
  ...
  "toast.update.description": "Uma nova versão do DEWCode ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do DEWCode",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (dewcode.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: DEWCode ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "DEWCode inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor DEWCode dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do DEWCode",
  ...
  "settings.general.row.appearance.description": "Personalize como o DEWCode aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o DEWCode segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o DEWCode é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o DEWCode iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do DEWCode.",
