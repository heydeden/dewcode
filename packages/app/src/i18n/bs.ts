export const dict = {
  ...
  "dialog.provider.dewcode.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.dewcode.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.dewcodeGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje DEWCode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u DEWCode-u.",
  ...
  "provider.connect.dewcodeZen.line1":
    "DEWCode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.dewcodeZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.dewcodeZen.visit.prefix": "Posjeti ",
  "provider.connect.dewcodeZen.visit.link": "dewcode.dev/zen",
  "provider.connect.dewcodeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u DEWCode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u DEWCode-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u dewcode.json",
  ...
  "dialog.server.description": "Promijeni na koji se DEWCode server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera DEWCode...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera DEWCode u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje DEWCode...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje DEWCode u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj DEWCode u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj DEWCode",
  "wsl.onboarding.dewcodeReadyIn": "DEWCode je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.dewcodeReady": "DEWCode je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj DEWCode u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj DEWCode",
  ...
  "wsl.onboarding.distroStatus.dewcodeMissing": "DEWCode nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi DEWCode mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "DEWCode nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori DEWCode.",
  ...
  "toast.update.description": "Nova verzija DEWCode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku DEWCode timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (dewcode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: DEWCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "DEWCode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni DEWCode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u DEWCode-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako DEWCode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li DEWCode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu DEWCode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se DEWCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju DEWCode-a.",
