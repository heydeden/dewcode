export const dict = {
  ...
  "dialog.provider.dewcode.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.dewcode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.dewcodeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez DEWCode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w DEWCode.",
  ...
  "provider.connect.dewcodeZen.line1":
    "DEWCode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.dewcodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.dewcodeZen.visit.link": "dewcode.dev/zen",
  "provider.connect.dewcodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w DEWCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w DEWCode.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w dewcode.json",
  ...
  "dialog.server.description": "Przełącz serwer DEWCode, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie DEWCode...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie DEWCode w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie DEWCode...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie DEWCode w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj DEWCode w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj DEWCode",
  "wsl.onboarding.dewcodeReadyIn": "DEWCode jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.dewcodeReady": "DEWCode jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj DEWCode w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj DEWCode",
  ...
  "wsl.onboarding.distroStatus.dewcodeMissing": "DEWCode nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim DEWCode będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "DEWCode nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz DEWCode.",
  ...
  "toast.update.description": "Nowa wersja DEWCode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu DEWCode",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (dewcode.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: DEWCode nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "DEWCode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer DEWCode wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla DEWCode",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd DEWCode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy DEWCode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw DEWCode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania DEWCode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji DEWCode.",
