export const dict = {
  ...
  "dialog.provider.dewcode.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.dewcode.tagline": "Modèles optimisés et fiables",
  "dialog.provider.dewcodeGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par DEWCode",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans DEWCode.",
  ...
  "provider.connect.dewcodeZen.line1":
    "DEWCode Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.dewcodeZen.visit.prefix": "Visitez ",
  "provider.connect.dewcodeZen.visit.link": "dewcode.dev/zen",
  "provider.connect.dewcodeZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans DEWCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans DEWCode.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans dewcode.json",
  ...
  "dialog.server.description": "Changez le serveur DEWCode auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'DEWCode...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'DEWCode dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'DEWCode...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'DEWCode dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour DEWCode dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour DEWCode",
  "wsl.onboarding.dewcodeReadyIn": "DEWCode est prêt dans {{distro}}.",
  "wsl.onboarding.dewcodeReady": "DEWCode est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez DEWCode dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer DEWCode",
  ...
  "wsl.onboarding.distroStatus.dewcodeMissing": "DEWCode non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'DEWCode puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "DEWCode n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez DEWCode.",
  ...
  "toast.update.description":
    "Une nouvelle version d'DEWCode ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe DEWCode",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (dewcode.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'DEWCode ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "DEWCode inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur DEWCode dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour DEWCode",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'DEWCode sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si DEWCode suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'DEWCode.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'DEWCode",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'DEWCode.",
