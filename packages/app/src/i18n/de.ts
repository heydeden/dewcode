...
export const dict = {
  ...
  "dialog.provider.dewcode.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.dewcode.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.dewcodeGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von DEWCode",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in DEWCode zu nutzen.",
  ...
  "provider.connect.dewcodeZen.line1":
    "DEWCode Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  "provider.connect.dewcodeZen.line2":
    "Mit einem einzigen API-Schlüssel erhalten Sie Zugriff auf Modelle wie Claude, GPT, Gemini, GLM und mehr.",
  "provider.connect.dewcodeZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.dewcodeZen.visit.link": "dewcode.dev/zen",
  "provider.connect.dewcodeZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in DEWCode zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in DEWCode zu nutzen.",
  ...
  "dialog.plugins.empty": "In dewcode.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den DEWCode-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.dewcode": "DEWCode",
  ...
  "wsl.onboarding.checkingOpencode": "DEWCode wird geprüft...",
  "wsl.onboarding.checkingOpencodeIn": "DEWCode in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingOpencode": "DEWCode wird aktualisiert...",
  "wsl.onboarding.updatingOpencodeIn": "DEWCode in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie DEWCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "DEWCode aktualisieren",
  "wsl.onboarding.dewcodeReadyIn": "DEWCode ist in {{distro}} bereit.",
  "wsl.onboarding.dewcodeReady": "DEWCode ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie DEWCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "DEWCode installieren",
  ...
  "wsl.onboarding.distroStatus.dewcodeMissing": "DEWCode nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor DEWCode einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "DEWCode konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann DEWCode erneut.",
  ...
  "toast.update.description": "Eine neue Version von DEWCode ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem DEWCode-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (dewcode.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: DEWCode unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "DEWCode enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "DEWCode Desktop",
  ...
  "settings.desktop.wsl.description": "DEWCode-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für DEWCode ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie DEWCode auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob DEWCode dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von DEWCode anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von DEWCode automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von DEWCode.",
