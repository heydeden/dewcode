export const dict = {
  ...
  "dialog.provider.dewcode.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.dewcode.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.dewcodeGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من DEWCode",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في DEWCode.",
  ...
  "provider.connect.dewcodeZen.line1":
    "يمنحك DEWCode Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.dewcodeZen.visit.prefix": "قم بزيارة ",
  "provider.connect.dewcodeZen.visit.link": "dewcode.dev/zen",
  "provider.connect.dewcodeZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في DEWCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في DEWCode.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في dewcode.json",
  ...
  "dialog.server.description": "تبديل خادم DEWCode الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من DEWCode...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من DEWCode في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث DEWCode...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث DEWCode في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث DEWCode في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث DEWCode",
  "wsl.onboarding.dewcodeReadyIn": "DEWCode جاهز في {{distro}}.",
  "wsl.onboarding.dewcodeReady": "DEWCode جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت DEWCode في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت DEWCode",
  ...
  "wsl.onboarding.distroStatus.dewcodeMissing": "DEWCode غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن DEWCode من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على DEWCode التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح DEWCode.",
  ...
  "toast.update.description": "نسخة جديدة من DEWCode ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق DEWCode",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (dewcode.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن DEWCode لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن DEWCode نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم DEWCode داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ DEWCode",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور DEWCode على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان DEWCode يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة DEWCode.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل DEWCode",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من DEWCode.",
