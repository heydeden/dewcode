...
beforeAll(async () => {
  ...
  mock.module("@dewcode-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@dewcode-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@dewcode-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@dewcode-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
