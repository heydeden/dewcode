...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "dewcode", key: "dialog.provider.dewcode.note" },
  { match: (id: string) => id === "dewcode-go", key: "dialog.provider.dewcodeGo.tagline" },
...
export const SettingsProvidersV2: Component<{
  ...
  const connected = createMemo(() => {
    return providers
      .connected()
      .filter((p) => p.id !== "dewcode" || Object.values(p.models).find((m) => m.cost?.input))
  })
                  ...
                  <div class="settings-v2-provider-lead">
                    ...
                    <div class="settings-v2-provider-copy">
                      <div class="settings-v2-provider-main">
                        ...
                        <Show when={item.id === "dewcode" || item.id === "dewcode-go"}>
