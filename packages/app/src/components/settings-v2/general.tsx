...
import { Switch } from "@dewcode-ai/ui/v2/switch-v2"
  ...
  const GeneralSection = () => (
    <div class="settings-v2-section">
      <SettingsListV2>
        ...
        <Show when={mobile() && import.meta.env.VITE_DEWCODE_CHANNEL !== "prod"}>
          <SettingsRowV2
        ...
        <SettingsRowV2
          ...
          description={
            <>
              ...
              <Link class="settings-v2-link" href="https://dewcode.dev/docs/themes/">
