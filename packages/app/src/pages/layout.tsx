...
import { base64Encode } from "@dewcode-ai/core/util/encode"
...
import { Session } from "@dewcode-ai/sdk/v2/client"
...
import { toaster } from "@dewcode-ai/ui/toast"
...
import { retry } from "@dewcode-ai/core/util/retry"
...
import { useTheme, type ColorScheme } from "@dewcode-ai/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://dewcode.dev/desktop-feedback")}
      renderPanel={() =>
