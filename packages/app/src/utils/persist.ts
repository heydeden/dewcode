...
const GLOBAL_STORAGE = "dewcode.global.dat"
const WINDOW_STORAGE = "dewcode.window"
const LOCAL_PREFIX = "dewcode."
...
function workspaceStorage(dir: string) {
  ...
  return `dewcode.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `dewcode.draft.${head}.${sum}.dat`
}
